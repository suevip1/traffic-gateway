package com.xl.traffic.chat.server.server.initializer;
 ...
 * @description
 * @date 2023/10/26 14:48:13
 */
public class ChatGptConnectionInitializer extends AbstractConnectionInitializer {
