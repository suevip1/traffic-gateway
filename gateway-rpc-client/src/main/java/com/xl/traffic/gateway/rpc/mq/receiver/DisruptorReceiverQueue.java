...
import com.xl.traffic.gateway.rpc.mq.MessageEvent;
 ...
 */
public class DisruptorReceiverQueue {

    private  RingBuffer<MessageEvent<ImMessage>> ringBuffer;

    public DisruptorReceiverQueue() {
        init();
    ...
    public  void init(){
        ...
        ChatGptReceiverConsumer[] consumers = new ChatGptReceiverConsumer[1];
        for (int i = 0; i < consumers.length; i++) {
            consumers[i] = new ChatGptReceiverConsumer();
        }
