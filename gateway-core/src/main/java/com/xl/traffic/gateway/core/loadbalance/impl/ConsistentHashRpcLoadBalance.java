package com.xl.traffic.gateway.core.loadbalance.impl;
...
/**
 * @Description:基于一致性hash的负载均衡算法
 *
 * //todo 考虑http协议时 在考虑这个算法
 * @Author: xl
 * @Date: 2021/6/23
 **/
@Component("consistenthash-balance")
public class ConsistentHashRpcLoadBalance implements RpcLoadBalance {
...
//    }
    ...
    public LoadBalanceType getType() {
        return LoadBalanceType.CONSISTENTHASH;
    }
